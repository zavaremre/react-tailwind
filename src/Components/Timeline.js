        ...
        >
          <aside
            className={classNames(
              ...
              { "mr-8": timeline.left, "ml-8": !timeline.left }
            )}
          >
            <div
            ...
            >
              ...
              <strong className="text-xs font-normal text-left mb-1">
                {timeline.position}
              </strong>
          ...
          <div
            className={classNames(
              "absolute w-3 h-3 rounded-full mt-1 z-10 shrink-0 pointer-events-none",
              {
          ...
          >
            <span
              className={classNames(
                "animate-ping absolute -left-1 -top-1 inline-flex h-5 w-5 rounded-full bg-blue-400  opacity-75",
                { hidden: !timeline.isActive }
              )}
            ></span>
          </div>
        </div>
