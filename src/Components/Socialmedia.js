    ...
    <ul className='relative flex justify-center items-center w-full gap-5 mb-4'>
      <li className='list-none'>
        <a
          ...
          aria-label='github'
          className='flex justify-center items-center w-10 h-10 rounded-full shadow-custom dark:shadow-black-900 p-2 bg-white dark:bg-black-800 transition-all duration-400 hover:-mt-2.5'>
